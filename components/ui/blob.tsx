...
export const BlobLarge = ({ className }: { className?: string }) => {
  return (
    <div className={cn('relative w-full max-w-lg z-0', className)}>
...
export const BlobMedium = ({ className }: { className?: string }) => {
  return (
    <div className={cn('relative w-full max-w-lg z-0', className)}>
